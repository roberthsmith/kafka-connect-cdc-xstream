...
class TimestampDatumConverter implements DatumConverter {
  @Override
  ...
  public Object toConnect(Schema schema, Datum datum) throws SQLException {
    java.sql.Timestamp timestamp = datum.timestampValue();
    return Timestamp.toLogical(schema, timestamp.getTime());
  }

  @Override
  public Datum toOracle(Schema schema, Object value) throws SQLException {
    java.util.Date date = (java.util.Date) value;
    return new TIMESTAMP(new java.sql.Timestamp(date.getTime()));
  }
}
