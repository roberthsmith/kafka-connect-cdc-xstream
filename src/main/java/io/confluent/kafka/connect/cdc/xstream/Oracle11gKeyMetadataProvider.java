...
class Oracle11gKeyMetadataProvider extends KeyMetadataProvider {
  private static final Logger log = LoggerFactory.getLogger(Oracle11gKeyMetadataProvider.class);
